...
<div class="card border-0 shadow-sm bg-body-tertiary">
    ...
    <div class="card-header bg-transparent d-flex justify-content-between align-items-center py-3" style="border-top: 5px solid #40BF89;">
        ...
        <a href="{{ route('admin.manage-admins.create') }}" class="btn text-white shadow-sm fw-bold" style="background-color: #40BF89; border: none;">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            @else
                                <span class="badge border text-dark px-3 py-2" style="background-color: rgba(64, 191, 137, 0.1); color: #40BF89; border-color: rgba(64, 191, 137, 0.3) !important;">
                                    Admin
                                </span>
                            @endif
                        </td>
                        <td class="text-center">
                            <div class="d-flex justify-content-center gap-2">
                                <a href="{{ route('admin.manage-admins.edit', $a->id) }}" class="btn btn-sm btn-outline-warning px-3 fw-medium">
                    ...
                    <tr>
                        <td colspan="5" class="text-center py-5 text-body-secondary">
                            <i class="bi bi-shield-slash d-block mb-2 text-body-tertiary" style="font-size: 3rem;"></i>
