            ...
            <div class="card border-0 shadow-sm bg-body-tertiary">
                ...
                <div class="card-body p-4">
                    <form action="{{ route('admin.pegawai.store') }}" method="POST">
                        ...
                        {{-- Input Lokasi / Wilayah Kerja --}}
                        <div class="mb-4">
                            <label class="form-label fw-bold text-body-secondary">Lokasi / Wilayah Kerja</label>
                            <div class="input-group">
                                <span class="input-group-text bg-body border-secondary-subtle border-end-0">
                                ...
                                <select name="location_id"
                                    ...
                                    required>
                                    <option value="" class="text-body">-- Pilih Lokasi / Wilayah Kerja --</option>
                                    @foreach ($locations as $loc)
                                        <option value="{{ $loc->id }}" class="text-body"
                            ...
                            <div class="input-group">
                                ...
                                <select name="pangkat_golongan"
                                    ...
                                    <optgroup label="Golongan V - IX (PPPK)" class="text-body">
                                        <option value="IX" {{ old('pangkat_golongan') == 'IX' ? 'selected' : '' }}>
                                            Golongan IX</option>
                                        <option value="VIII" {{ old('pangkat_golongan') == 'VIII' ? 'selected' : '' }}>
                                            Golongan VIII</option>
                                        <option value="VII" {{ old('pangkat_golongan') == 'VII' ? 'selected' : '' }}>
                                            Golongan VII</option>
                                        <option value="VI" {{ old('pangkat_golongan') == 'VI' ? 'selected' : '' }}>
                                            Golongan VI</option>
                                        <option value="V" {{ old('pangkat_golongan') == 'V' ? 'selected' : '' }}>
                                            Golongan V</option>
                                    </optgroup>

                                    {{-- Golongan IV (Pembina) --}}
                                    <optgroup label="Golongan IV (Pembina)" class="text-body">
                                        <option value="IV/e" {{ old('pangkat_golongan') == 'IV/e' ? 'selected' : '' }}>
                                            Pembina Utama (IV/e)</option>
                                        <option value="IV/d" {{ old('pangkat_golongan') == 'IV/d' ? 'selected' : '' }}>
                                            Pembina Utama Madya (IV/d)</option>
                                        <option value="IV/c" {{ old('pangkat_golongan') == 'IV/c' ? 'selected' : '' }}>
                                            Pembina Utama Muda (IV/c)</option>
                                        <option value="IV/b" {{ old('pangkat_golongan') == 'IV/b' ? 'selected' : '' }}>
                                            Pembina Tingkat I (IV/b)</option>
                                        <option value="IV/a" {{ old('pangkat_golongan') == 'IV/a' ? 'selected' : '' }}>
                                            Pembina (IV/a)</option>
                                    </optgroup>

                                    {{-- Golongan III (Penata) --}}
                                    <optgroup label="Golongan III (Penata)" class="text-body">
                                        <option value="III/d" {{ old('pangkat_golongan') == 'III/d' ? 'selected' : '' }}>
                                            Penata Tingkat I (III/d)</option>
                                        <option value="III/c" {{ old('pangkat_golongan') == 'III/c' ? 'selected' : '' }}>
                                            Penata (III/c)</option>
                                        <option value="III/b" {{ old('pangkat_golongan') == 'III/b' ? 'selected' : '' }}>
                                            Penata Muda Tingkat I (III/b)</option>
                                        <option value="III/a" {{ old('pangkat_golongan') == 'III/a' ? 'selected' : '' }}>
                                            Penata Muda (III/a)</option>
                                    </optgroup>

                                    {{-- Golongan II (Pengatur) --}}
                                    <optgroup label="Golongan II (Pengatur)" class="text-body">
                                        <option value="II/d" {{ old('pangkat_golongan') == 'II/d' ? 'selected' : '' }}>
                                            Pengatur Tingkat I (II/d)</option>
                                        <option value="II/c" {{ old('pangkat_golongan') == 'II/c' ? 'selected' : '' }}>
                                            Pengatur (II/c)</option>
                                        <option value="II/b" {{ old('pangkat_golongan') == 'II/b' ? 'selected' : '' }}>
                                            Pengatur Muda Tingkat I (II/b)</option>
                                        <option value="II/a" {{ old('pangkat_golongan') == 'II/a' ? 'selected' : '' }}>
                                            Pengatur Muda (II/a)</option>
                                    </optgroup>

                                    {{-- Golongan I (Juru) --}}
                                    <optgroup label="Golongan I (Juru)" class="text-body">
                                        <option value="I/d" {{ old('pangkat_golongan') == 'I/d' ? 'selected' : '' }}>
                                            Juru Tingkat I (I/d)</option>
                                        <option value="I/c" {{ old('pangkat_golongan') == 'I/c' ? 'selected' : '' }}>
                                            Juru (I/c)</option>
                                        <option value="I/b" {{ old('pangkat_golongan') == 'I/b' ? 'selected' : '' }}>
                                            Juru Muda Tingkat I (I/b)</option>
                                        <option value="I/a" {{ old('pangkat_golongan') == 'I/a' ? 'selected' : '' }}>
                            ...
                            <div class="input-group">
                                ...
                                <select name="pendidikan"
                                    ...
                                    <optgroup label="Pendidikan Menengah / Sederajat" class="text-body">
                                        <option value="SLTA" {{ old('pendidikan') == 'SLTA' ? 'selected' : '' }}>SLTA /
                                            SMA / SMK / MA</option>
                                    </optgroup>

                                    {{-- Program Diploma --}}
                                    <optgroup label="Program Diploma" class="text-body">
                                        <option value="D-I" {{ old('pendidikan') == 'D-I' ? 'selected' : '' }}>Diploma
                                            I (D1)</option>
                                        <option value="D-II" {{ old('pendidikan') == 'D-II' ? 'selected' : '' }}>Diploma
                                            II (D2)</option>
                                        <option value="D-III" {{ old('pendidikan') == 'D-III' ? 'selected' : '' }}>
                                            Diploma III (D3)</option>
                                        <option value="D-IV" {{ old('pendidikan') == 'D-IV' ? 'selected' : '' }}>Diploma
                                            IV (D4)</option>
                                    </optgroup>

                                    {{-- Program Sarjana & Pascasarjana --}}
                                    <optgroup label="Program Sarjana & Pascasarjana" class="text-body">
                                        <option value="S1" {{ old('pendidikan') == 'S1' ? 'selected' : '' }}>Sarjana
                                            (S1)</option>
                                    ...
                                    <optgroup label="Program Profesi / Spesialis" class="text-body">
                                        <option value="Profesi" {{ old('pendidikan') == 'Profesi' ? 'selected' : '' }}>
                                            Profesi (Apoteker, Ners, Dokter, dll.)</option>
                                        <option value="Spesialis"
                                            {{ old('pendidikan') == 'Spesialis' ? 'selected' : '' }}>Spesialis (Sp.A,
                                            Sp.PD, dll.)</option>
                                    </optgroup>
                                </select>
                            </div>
