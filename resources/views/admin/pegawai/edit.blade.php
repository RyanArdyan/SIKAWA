                    ...
                    <form action="{{ route('admin.pegawai.update', $pegawai->id) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group @error('nip') has-validation @enderror">
                                <span
                                    class="input-group-text bg-body border-secondary-subtle border-end-0 @error('nip') border-danger @enderror">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group @error('name') has-validation @enderror">
                                <span
                                    class="input-group-text bg-body border-secondary-subtle border-end-0 @error('name') border-danger @enderror">
                        ...
                        <select name="gender"
                            ...
                            <option value="Laki-laki"
                                {{ old('gender', $pegawai->gender) == 'Laki-laki' ? 'selected' : '' }}>
                                Laki-laki
                            </option>

                            <option value="Perempuan"
                                {{ old('gender', $pegawai->gender) == 'Perempuan' ? 'selected' : '' }}>
                                Perempuan
                            </option>
                        </select>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group @error('tim_kerja_id') has-validation @enderror">
                                <span
                                    class="input-group-text bg-body border-secondary-subtle border-end-0 @error('tim_kerja_id') border-danger @enderror">
                            ...
                            <div class="form-text mt-2 text-body-secondary" style="font-size: 0.85rem;">
                                <i class="bi bi-info-circle me-1 text-info"></i> Pilih tim kerja baru jika pegawai pindah
                                posisi laporan.
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group @error('location_id') has-validation @enderror">
                                <span
                                    class="input-group-text bg-body border-secondary-subtle border-end-0 @error('location_id') border-danger @enderror">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group @error('pangkat_golongan') has-validation @enderror">
                                <span
                                    class="input-group-text bg-body border-secondary-subtle border-end-0 @error('pangkat_golongan') border-danger @enderror">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group @error('jabatan') has-validation @enderror">
                                <span
                                    class="input-group-text bg-body border-secondary-subtle border-end-0 @error('jabatan') border-danger @enderror">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group @error('kelas_jabatan') has-validation @enderror">
                                <span
                                    class="input-group-text bg-body border-secondary-subtle border-end-0 @error('kelas_jabatan') border-danger @enderror">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group @error('pendidikan') has-validation @enderror">
                                <span
                                    class="input-group-text bg-body border-secondary-subtle border-end-0 @error('pendidikan') border-danger @enderror">
                                ...
                                <select name="pendidikan"
                                    ...
                                    <optgroup label="Pendidikan Menengah / Sederajat" class="text-body">
                                        <option value="SLTA"
                                            {{ old('pendidikan', $pegawai->pendidikan) == 'SLTA' ? 'selected' : '' }}>SLTA
                                            / SMA / SMK / MA</option>
                                    </optgroup>
                                    ...
                                    <optgroup label="Program Sarjana & Pascasarjana" class="text-body">
                                        <option value="S1"
                                            {{ old('pendidikan', $pegawai->pendidikan) == 'S1' ? 'selected' : '' }}>Sarjana
                                            (S1)</option>
                                        <option value="S2"
                                            {{ old('pendidikan', $pegawai->pendidikan) == 'S2' ? 'selected' : '' }}>
                                            Magister (S2)</option>
                                        <option value="S3"
                                            {{ old('pendidikan', $pegawai->pendidikan) == 'S3' ? 'selected' : '' }}>Doktor
                                            (S3)</option>
                                    </optgroup>
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <p class="mb-0 text-body-secondary" style="font-size: 0.85rem;">
                                        Email: <span
                                            class="badge bg-body text-body-secondary border border-secondary-subtle fw-medium">{{ $pegawai->nip }}@bkk.go.id</span>
                                        <br>
                                        Password: <span
