    ...
    <div class="col-md-7">
        <div class="card border-0 shadow-sm mb-4">
            ...
            <div class="card-body p-4">
                @if(session('success'))
                    <div class="alert alert-success alert-dismissible fade show border-0 text-white shadow-sm mb-4" role="alert" style="background-color: #40BF89;">
                ...
                <form action="{{ route('admin.settings.update') }}" method="POST">
                    ...
                    <div class="alert alert-light border-start border-4 mb-4" style="border-color: #40BF89 !important; background-color: rgba(64, 191, 137, 0.05);">
                    ...
                    <div class="d-grid mt-2">
                        <button type="submit" class="btn text-white btn-lg shadow-sm" style="background-color: #40BF89; border: none;">
    ...
    <div class="col-md-5">
        <div class="card border-0 shadow-sm text-white" style="background: linear-gradient(135deg, #2c3e50, #4a6076);">
            <div class="card-body p-4">
                ...
                <p class="small opacity-75">Pengaturan ini berlaku secara global. Perubahan akan langsung berdampak pada:</p>
