...
<div class="row justify-content-center">
    <div class="col-md-4">
        <div class="card shadow border-0 mt-5">
            {{-- Mengubah bg-dark menjadi warna hijau SIKAWA dan teks disesuaikan --}}
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <span class="input-group-text bg-body border-start-0 cursor-pointer text-secondary" id="toggle-password-btn" style="cursor: pointer;">
                                <i class="bi bi-eye" id="toggle-password-icon"></i>
                            </span>
                        </div>
                    </div>

                    {{-- Mengubah btn-primary menjadi tombol dengan warna hijau SIKAWA --}}
